...
// load the styles
var content = __webpack_require__(6535);
if(content.__esModule) content = content.default;
if(typeof content === 'string') content = [[module.id, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = (__webpack_require__(4402)/* ["default"] */ .Z)
var update = add("e3b2c8a0", content, true, {"sourceMap":false,"shadowMode":false});
...
var ChargesComponentvue_type_style_index_0_id_50f5e5a8_prod_scoped_true_lang_css_ = __webpack_require__(1561);
